      ...
      <div className="max-w-md mx-auto px-4 py-20">
        <div className="paper-card p-8 text-center">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white border border-[rgba(0,0,0,0.12)] rounded-lg text-sm font-medium text-ink-dark hover:bg-gray-50 hover:border-[rgba(0,0,0,0.2)] transition-all shadow-sm"
          >
