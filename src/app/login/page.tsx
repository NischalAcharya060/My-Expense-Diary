      ...
      <div className="max-w-md mx-auto px-4 py-16">
        <div className="paper-card p-8 text-center relative rotate-[0.5deg]">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white dark:bg-paper-dark border border-[rgba(0,0,0,0.12)] rounded-lg text-sm font-medium text-neutral-800 dark:text-ink-dark hover:bg-gray-50 dark:hover:bg-paper-bg hover:border-[rgba(0,0,0,0.2)] transition-all shadow-sm cursor-pointer"
          >
