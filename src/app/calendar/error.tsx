  ...
  return (
    <div className="notebook-paper min-h-screen p-8 pt-16 lg:pl-20">
      <div className="paper-card p-8 max-w-md mx-auto text-center">
        ...
        <h2 className="font-handwritten text-2xl text-ink-dark mb-2">Couldn&apos;t load calendar</h2>
        <p className="text-sm text-ink-light mb-4">
          Failed to load your expense calendar. Check your connection and try again.
        </p>
        <button
          onClick={reset}
